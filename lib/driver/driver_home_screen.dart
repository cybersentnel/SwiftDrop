...
class _DriverHomeScreenState extends State<DriverHomeScreen> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> screens = [
      ...
      EarningsScreen(),
      _DriverProfileTab(
        onSwitchRole: () => Navigator.pushReplacement(context,
...
_OrdersTab({
    required this.isOnline, required this.orders,
    ...
    return CustomScrollView(slivers: [
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isOnline
                        ? AppTheme.success.withAlpha(128) : AppTheme.border,
                  ),
                ),
      ...
      SliverToBoxAdapter(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isOnline
                ? AppTheme.success.withAlpha(20) : AppTheme.surface,
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
              color: isOnline
                  ? AppTheme.success.withAlpha(77) : AppTheme.border,
            ),
          ),
          child: Row(children: [
            Text(isOnline ? '🟢' : '🔴',
            ...
            if (isOnline)
              const Column(crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                Text('KSh 4,720', style: TextStyle(
      ...
      if (isOnline && orders.isNotEmpty) ...[
        ...
        SliverFillRemaining(
          ...
          child: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            SizedBox(height: 16),
            Text('No orders right now', style: TextStyle(
      ...
      child: Column(children: [
        Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Expanded(child: Text(order.pickupName, style: const TextStyle(
              ...
              Container(
                ...
                child: Text('KSh ${order.payout.toInt()}',
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
             ...
             SizedBox(width: 12),
              ...
              Expanded(child: Column(
                ...
                Text(order.dropoffAddress, style: const TextStyle(
                    color: AppTheme.textPrimary, fontSize: 13,
                    fontWeight: FontWeight.w600)),
              ])),
            ]),
           SizedBox(height: 12),
            ...
            Row(children: [
              _Stat(icon: Icons.near_me_outlined,
                  label: '${order.distanceKm} km'),
              SizedBox(width: 16),
              _Stat(icon: Icons.schedule_outlined,
            ...
            Container(
              ...
              child: Row(children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text(order.items.join(' · '),
                    style: TextStyle(
                        color: AppTheme.textSecondary, fontSize: 12),
...
class _DriverProfileTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      ('M-Pesa Account', Icons.phone_android_outlined),
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        Center(child: Column(children: [
          Container(
            width: 80, height: 80,
            decoration: BoxDecoration(
              color: AppTheme.successDim, shape: BoxShape.circle,
              border: Border.all(
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            SizedBox(width: 4),
            Text('4.97', style: TextStyle(fontWeight: FontWeight.w800,
                color: AppTheme.textPrimary, fontSize: 16)),
            Text(' · 2,341 deliveries',
        ...
        Container(
          ...
          child: ListTile(
            ...
            title: const Text('Switch to Customer', style: TextStyle(
